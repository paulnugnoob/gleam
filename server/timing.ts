...
export class AnalysisTimer {
  ...
  logReport(): void {
    ...
    console.log(`  Total Time:       ${(report.totalDurationMs / 1000).toFixed(2)}s`);
    console.log("\nBREAKDOWN:");
    console.log(`  Download:         ${(report.summary.download / 1000).toFixed(2)}s`);
    console.log(`  Frame Extraction: ${(report.summary.frameExtraction / 1000).toFixed(2)}s`);
    console.log(`  Audio Extraction: ${(report.summary.audioExtraction / 1000).toFixed(2)}s`);
    console.log(`  AI Analysis:      ${(report.summary.aiAnalysis / 1000).toFixed(2)}s`);
    console.log(`  Product Matching: ${(report.summary.productMatching / 1000).toFixed(2)}s`);
    console.log(`  DB Operations:    ${(report.summary.dbOperations / 1000).toFixed(2)}s`);
    console.log("=".repeat(60) + "\n");
  }
}
