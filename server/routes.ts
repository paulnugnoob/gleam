      ...
      const feedback = await storage.getFeedbackForAnalysis(id);
        ...
        products: products.map((p) => ({
          ...
          aiDetectedType: p.aiDetectedType,
            ...
            matchedProductSource: p.matchedProductSource,
            matchedProductSourceId: p.matchedProductSourceId,
            matchedProductMarketplace: p.matchedProductMarketplace,
          ...
          matchedProductAlternatives: p.matchedProductAlternatives,
